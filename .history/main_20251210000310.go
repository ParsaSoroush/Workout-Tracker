...
func main() {
	...
	auth.PUT("/workouts/:workout_id/exercises/:exercise_id", UpdateWorkoutExerciseEntry)
	...
	auth.PUT("/exercises/:exercise_id", UpdateExercise)
	auth.DELETE("/exercises/:exercise_id", DeleteExercise)
